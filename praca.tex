...
W ramach niniejszej pracy przeprowadzono szczegółową analizę semantyki instrukcji \texttt{force}/\texttt{release} w odniesieniu do standardu IEEE, ze szczególnym uwzględnieniem jej relacji do innych mechanizmów przypisań występujących w językach Verilog i SystemVerilog, takich jak przypisania ciągłe, proceduralne oraz proceduralne ciągłe. Analiza ta pozwoliła na jednoznaczne określenie oczekiwanego, obserwowalnego zachowania sygnałów w obecności wymuszeń oraz na identyfikację przypadków problematycznych z punktu widzenia implementacji w symulatorach opartych na kompilacji.
