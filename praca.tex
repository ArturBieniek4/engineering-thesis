...
& Czas [\%] & RAM [\%] \\
\hline
\benchrow{NVDLA\cite{NVDLA}}{1750.72}{8831.61}{1829.60}{8836.99}
\benchrow{OpenPiton\cite{OpenPiton}}{558.12}{2707.13}{583.44}{2705.78}
\benchrow{OpenTitan\cite{opentitan}}{369.50}{1844.17}{377.22}{1845.45}
\benchrow{VeeR\cite{veer_eh2}}{208.56}{857.07}{194.90}{856.72}
\benchrow{Vortex\cite{vortex}}{283.98}{1142.52}{284.10}{1145.18}
\benchrow{XuanTie\cite{XUANTIE_C910}}{544.16}{2803.48}{544.94}{2803.47}
\end{tabular*}
...
& Czas [\%] & RAM [\%] \\
\hline
\benchrow{NVDLA}{319.45}{1234.19}{280.31}{1234.30}
\benchrow{OpenPiton}{81.32}{41.20}{80.32}{41.12}
\benchrow{OpenTitan}{146.93}{22.21}{150.48}{22.06}
\benchrow{VeeR}{105.78}{11.44}{102.97}{11.38}
\benchrow{Vortex}{50.87}{19.44}{50.99}{19.40}
\benchrow{XuanTie}{113.21}{5.43}{120.84}{5.43}
...
Wyniki pokazują, że wprowadzone zmiany \textbf{nie wpływają istotnie na zużycie pamięci}, zarówno podczas pełnej verilacji, jak i symulacji — różnice są pomijalne i mieszczą się w granicach błędu pomiarowego. W przypadku pełnej verilacji obserwowany jest umiarkowany narzut czasowy dla większości designów, z wyjątkiem VeeR, dla którego odnotowano zauważalne przyspieszenie. Podczas symulacji zmiany mają charakter mieszany: dla NVDLA i VeeR widoczna jest umiarkowana poprawa czasu wykonania, natomiast dla XuanTie i OpenTitan występuje niewielka regresja. Ogólnie implementacja zachowuje porównywalną wydajność, a obserwowane różnice czasowe są zależne od charakterystyki designu.
